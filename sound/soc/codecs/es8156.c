...
/*
 * BSP spk-con-gpio / hp-det-gpio handling is not ported (unused on
 * AtriStation: amplifiers are enabled by their pvdd regulator). Kept as a
 * no-op so the mute sequencing stays readable.
 */
