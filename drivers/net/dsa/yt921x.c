			    ...
			    struct dsa_mall_policer_tc_entry *policer)
{
	...
	/* The 6.18 DSA core only passes rate/burst in bytes; packet-per-second
	...
	res = yt921x_marker_tfm(&marker, policer->rate_bytes_per_sec,
...
static int yt921x_mdio_probe(struct mdio_device *mdiodev)
{
	...
	/* Optional SMI switch ID for boards with multiple chips sharing the
	 * same management scheme (e.g. one chip strapped to ID 0, another to
